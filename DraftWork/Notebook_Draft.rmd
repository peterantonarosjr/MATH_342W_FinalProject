...
length(which(correlationMatrix2==1)) # 27 matches for perfect correlation, 2 columns are perfectly correlated
...
#I also would not trust this RMSE simply because it is highly variable (dependent on the split in the above cell)
