...
Establishing New Data Table (Subset of finalHousingData)
```{r}

#Subset of features we will be using from finalHousingData
subsetF = c(predictors(trained_selection),"sale_price") # Add back sale price since we excluded it from feature importance

finalHousingData_Sub = finalHousingData[,..subsetF]

#finalHousingData_sub where the features < features from finalHousingData
finalHousingData_Sub
```



Establishing Holdout Sets (Full & Sub Data Set)
```{r}
...
Regression Tree Model (Full Data Set)
```{r}
...
Regression Tree Model (Sub Data Set)
```{r}
...
Random Forest Model (Full Data Set)
```{r}
...
Random Forest Model (Sub Data Set)
```{r}
...
Bagged Random Forest Model (Full Data Set)
```{r}
...
Bagged Random Forest Model (Sub Data Set)
```{r}
